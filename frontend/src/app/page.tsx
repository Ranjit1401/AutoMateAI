...
const recentTasks = [
  { icon: MapPin, title: 'Plan trip to Tokyo for 7 days', status: 'completed', time: '2 min ago', color: '#a855f7' },
  { icon: Mail, title: 'Draft Q3 investor update email', status: 'running', time: '5 min ago', color: '#06b6d4' },
  { icon: FileText, title: 'Analyze competitor pricing doc', status: 'running', time: '12 min ago', color: '#10b981' },
  { icon: Calendar, title: 'Schedule team standup for next week', status: 'completed', time: '1 hr ago', color: '#f59e0b' },
  { icon: Search, title: 'Research AI trends in healthcare 2025', status: 'waiting', time: '3 hr ago', color: '#ec4899' },
]

const connectedApps = [
  { name: 'Gmail', color: '#EA4335', letter: 'G' },
  { name: 'Drive', color: '#4285F4', letter: 'D' },
  { name: 'Slack', color: '#4A154B', letter: 'S' },
  { name: 'Notion', color: '#FFFFFF', letter: 'N' },
  { name: 'GitHub', color: '#24292e', letter: 'H' },
  { name: 'Spotify', color: '#1DB954', letter: 'Sp' },
  { name: 'Calendar', color: '#0F9D58', letter: 'C' },
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            {quickActions.map(({ icon: Icon, label, color, desc }) => (
              <button
                key={label}
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
            ...
            >
              ...
              >
                ...
                />
                <span style={{ fontSize: 13, fontWeight: 600, color: 'white' }}>AI Online</span>
              </div>

              {[
                { icon: Zap, label: 'Latency', value: '12ms', color: '#10b981' },
                { icon: Database, label: 'Memory', value: '2.4 GB', color: '#a855f7' },
                { icon: Plug, label: 'Tools', value: '10 connected', color: '#06b6d4' },
                { icon: Activity, label: "Today's Tasks", value: '7 tasks', color: '#f59e0b' },
                { icon: Cpu, label: 'Tokens Used', value: '142k / 1M', color: '#ec4899' },
